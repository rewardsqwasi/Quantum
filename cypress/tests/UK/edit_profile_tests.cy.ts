...
describe('UK Region - Edit Profile Tests', () => {
  ...
  it('Verify questions and inputs in the "A little bit about you and your company" exist', () => {  
    ...
    app.profilePage.howManyDakeaSelectElement().should('be.visible');
    ...
    app.profilePage.recommendDakeaSelectElement().should('be.visible'); 
  });
  ...
  it('Verify the answers are pre-populated when the edit profile page is accessed.', () => {  
    ...
    app.profilePage.howManyDakeaSelectElement().find('option:selected').should('have.length', 1);
    ...
    app.profilePage.recommendDakeaSelectElement().find('option:selected').should('have.length', 1);  
  });
