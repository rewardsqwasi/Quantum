...
describe('Home Page', () => {
    ...
    it('should handle network errors gracefully', () => {
        try {
            ...
            cy.intercept('GET', 'https://memberportal.velux.qwasi.com/uk/terms-and-conditions', {
                statusCode: 500,
                body: 'Server Error',
    ...
    it('should handle network errors gracefully', () => {
        try {
            ...
            cy.intercept('GET', 'https://www.velux.co.uk/legal/privacy-policy', {
                statusCode: 500,
                body: 'Server Error',
                headers: { 'content-type': 'text/plain' },
            }).as('termsRequest');
    ...
    it('should handle network errors gracefully', () => {
        try {
            ...
            cy.intercept('GET', 'https://stage.memberportal.velux.qwasi.com/uk/contact', {
                statusCode: 500,
                body: 'Server Error',
                headers: { 'content-type': 'text/plain' },
            }).as('termsRequest');
    ...
    it('should handle network errors gracefully', () => {
        try {
            ...
            cy.intercept('GET', 'https://stage.memberportal.velux.qwasi.com/uk/how-to-earn-points', {
                statusCode: 500,
                body: 'Server Error',
                headers: { 'content-type': 'text/plain' },
            }).as('termsRequest');
