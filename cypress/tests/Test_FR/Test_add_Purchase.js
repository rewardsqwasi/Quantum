...
describe('To Verify Add Purchase', () => {
  ...
  it('Should verify all header links are present and clickable', () => {
    ...
    const headerLinks = [
      ...
      'https://stage.memberportal.velux.qwasi.com/fr/add-purchase',
      'https://stage.memberportal.velux.qwasi.com/fr/claim-rewards',
      'https://stage.memberportal.velux.qwasi.com/fr/rewards-calculator',
      'https://stage.memberportal.velux.qwasi.com/fr/dashboard'
    ];
