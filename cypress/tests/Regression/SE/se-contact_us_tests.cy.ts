...
describe('SE Region - Contact Us Tests', () => {
  ...
  it('Verify Page Title', () => {
    app.getPageTitle().should('eq','VELUX Hantverkarbonus - Kontakta');
  });
  ...
  it('Verify Contact Us Section', () => {
    ...
    app.contactUsPage.headingElement().should('have.text', 'Kontakta oss');
  ...
  it('Verify that the email address listed on the page is correct and functional.', () => {
    ...
    app.contactUsPage.emailElement().should('have.text', 'info@velux.se');
    app.contactUsPage.emailElement().should('have.attr', 'href', 'mailto:info@velux.se');
  });
