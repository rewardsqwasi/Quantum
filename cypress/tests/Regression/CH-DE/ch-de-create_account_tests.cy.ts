...
describe('CH (DE lang) Region - Create Account Tests', () => {
  ...
  it('Verify that Placeholders for all the fields exist.', () => {
    app.createAccountPage.firstNameFieldElement().should('have.attr', 'placeholder',"Bitte geben Sie Ihren Vornamen ein *");
    app.createAccountPage.lastNameFieldElement().should('have.attr', 'placeholder',"Bitte geben Sie Ihren Nachnamen ein *");
    app.createAccountPage.companyNameFieldElement().should('have.attr', 'placeholder',"Bitte geben Sie Ihren Firmennamen ein *");
    app.createAccountPage.companyNumberFieldElement().should('have.attr', 'placeholder',"Bitte geben Sie Ihre VELUX Kundennummer *");
    app.createAccountPage.address1FieldElement().should('have.attr', 'placeholder',"Bitte geben Sie Ihre Strasse ein *");
    app.createAccountPage.address2FieldElement().should('have.attr', 'placeholder',"Bitte geben Sie Ihren Adresszusatz ein*");
    app.createAccountPage.postcodeFieldElement().should('have.attr', 'placeholder',"Bitte geben Sie Ihre Postleizahl ein *");
    app.createAccountPage.townFieldElement().should('have.attr', 'placeholder',"Bitte geben Sie Ihr Ort ein *"); 
    ...
    app.createAccountPage.websiteFieldElement().should('have.attr', 'placeholder',"Webseite betreten");
