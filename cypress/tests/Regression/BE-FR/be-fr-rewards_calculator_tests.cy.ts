...
describe('BE (FR lang) Region - Rewards Calculator Tests', () => {
  ...
  it('Verify Page Title', () => {
    app.getPageTitle().should('eq','VELUX Club - Calcul des points');
  });
  ...
  it('Verify Placeholder', () => {
    app.rewardsCalculatorPage.enterProductCodeSpanElement().should('have.text', 'Entrez le code produit');
  });
