...
describe('BE (FR lang) Region - Create Account Tests', () => {
  ...
  it('Verify Create Account Page URL', () => {
    ...
    app.getPageTitle().should('eq','VELUX Club - Enregistrement');
  });
  ...
  it('Verify that Placeholders for all the fields exist.', () => {
    ...
    app.createAccountPage.companyNumberFieldElement().should('have.attr', 'placeholder',"Le numéro TVA de votre société *");
    app.createAccountPage.customerNumberFieldElement().should('have.attr', 'placeholder',"Numéro client VELUX");
    ...
    app.createAccountPage.websiteFieldElement().should('have.attr', 'placeholder',"Entrez le site Web");
