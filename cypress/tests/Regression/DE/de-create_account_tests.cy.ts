...
describe('DE Region - Create Account Tests', () => {
  ...
  it('Verify Check email section', () => {
    app.createAccountPage.checkEmailFieldElement().should('be.visible').and('have.attr', 'placeholder', 'Bitte geben Sie ihre E-Mail-Adresse ein');
    app.createAccountPage.checkEmailSubmitBtnElement().should('be.visible');
    app.createAccountPage.welcomeHeadingElement().should('be.visible');
    app.createAccountPage.enterCheckEmail(newEmail);
  });
  ...
  it('Verify Profile Details Section', () => {
    ...
    app.createAccountPage.taxNumberFieldElement().should('be.visible');
  ...
  it('Verify that Placeholders for all the fields exist.', () => {
    ...
    app.createAccountPage.taxNumberFieldElement().should('have.attr', 'placeholder', 'Steuernummer');
    ...
    app.createAccountPage.passwordFieldElement().should('have.attr', 'placeholder',"Bitte erstellen Sie ein sicheres Passwort (mindestens 8 bis maximal 20 Zeichen)*");
  });
  ...
  it('Verify the Max length in all the fields.', () => {
    ...
    app.createAccountPage.taxNumberFieldElement().should('have.attr', 'maxlength',"11"); 
