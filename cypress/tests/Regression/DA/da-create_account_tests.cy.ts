...
describe('DA Region - Create Account Tests', () => {
  ...
  it('Verify Social Media Info Section', () => {
    app.createAccountPage.socialMediaInfoHeading2Element().should('be.visible');
    app.createAccountPage.viewSocialMediaInfoHeading2();
  ...
  it('Verify Create Account Login Section', () => {
    app.createAccountPage.createAccountLoginHeading2Element().should('be.visible');
    app.createAccountPage.viewCreateAccountLoginHeading2();
  ...
  it('Verify that Placeholders for all the fields exist.', () => {
    app.createAccountPage.firstNameFieldElement().should('have.attr', 'placeholder',"Enter First Name *");
    app.createAccountPage.lastNameFieldElement().should('have.attr', 'placeholder',"Enter Surname *");
    app.createAccountPage.companyNameFieldElement().should('have.attr', 'placeholder',"Enter Company Name *");
    ...
    app.createAccountPage.postcodeFieldElement().should('have.attr', 'placeholder',"Enter Postcode *");
