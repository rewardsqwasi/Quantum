...
describe('CH (FR lang) Region - Login Tests', () => {
  ...
  it('Verify placeholders for email and password.', () => {
    ...
    app.loginPage.passwordFieldElement().should('have.attr', 'placeholder', 'Veuillez entrer votre mot de passe');
  });
  ...
  it('Verify Press Enter key without adding any field values for email and password.', () => {
    ...
    app.loginPage.getEmailFieldErrorMsg().should('eq', 'Veuillez entrer votre adresse e-mail');
    app.loginPage.getPasswordFieldErrorMsg().should('eq', 'Veuillez entrer le mot de passe');
  });
  ...
  it('Verify Enter Invalid Credentails (Email and Password)', () => {
    ...
    app.loginPage.getToastMessagText().should('eq', 'Identifiant ou mot de passe invalide.');
  });
