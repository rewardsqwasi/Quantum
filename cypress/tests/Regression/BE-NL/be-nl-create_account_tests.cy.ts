...
describe('BE (NL lang) Region - Create Account Tests', () => {
  ...
  it('Verify Create Account Page URL', () => {
    ...
    app.getPageTitle().should('eq','VELUX Club - Een account aanmaken');
  });
  ...
  it('Verify Profile Details Section', () => {
    ...
    app.createAccountPage.customerNumberFieldElement().should('be.visible');
  ...
  it('Verify that Placeholders for all the fields exist.', () => {
    app.createAccountPage.firstNameFieldElement().should('have.attr', 'placeholder',"Uw voornaam *");
    app.createAccountPage.lastNameFieldElement().should('have.attr', 'placeholder',"Uw achternaam *");
    app.createAccountPage.companyNameFieldElement().should('have.attr', 'placeholder',"Bedrijfsnaam *");
    app.createAccountPage.companyNumberFieldElement().should('have.attr', 'placeholder',"BTW nummer van uw bedrijf *");
    app.createAccountPage.customerNumberFieldElement().should('have.attr', 'placeholder',"VELUX Klantennummer");
    app.createAccountPage.address1FieldElement().should('have.attr', 'placeholder',"Adreslijn 1 *");
    app.createAccountPage.address2FieldElement().should('have.attr', 'placeholder',"Adreslijn 2");
    app.createAccountPage.postcodeFieldElement().should('have.attr', 'placeholder',"Postcode *");
    app.createAccountPage.townFieldElement().should('have.attr', 'placeholder',"Stad / gemeente *");
    app.createAccountPage.mobileFieldElement().should('have.attr', 'placeholder',"0470 12 34 56");
    app.createAccountPage.verifyMobileFieldElement().should('have.attr', 'placeholder',"0470 12 34 56");
    ...
    app.createAccountPage.emailFieldElement().should('have.attr', 'placeholder',"Uw e-mailadres *");
    app.createAccountPage.verifyEmailFieldElement().should('have.attr', 'placeholder',"Uw e-mailadres *");
    app.createAccountPage.passwordFieldElement().should('have.attr', 'placeholder',"Voer uw pincode in *");
  });
  ...
  it('Verify the Max length in all the fields.', () => {
    ...
    app.createAccountPage.companyNumberFieldElement().should('have.attr', 'maxlength',"12");
    app.createAccountPage.customerNumberFieldElement().should('have.attr', 'maxlength',"20");
