...
describe('NL Region - Edit Profile Tests', () => {
  ...
  it('Verify questions and inputs in the "A little bit about you and your company" exist', () => {  
    ...
    app.profilePage.veluxRewardSelectElement().should('be.visible');
  ...
  it('Verify the answers are pre-populated when the edit profile page is accessed.', () => {  
    ...
    app.profilePage.veluxRewardSelectElement().find('option:selected').should('have.length', 1);
