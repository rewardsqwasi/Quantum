...
describe('IE Region - Add User Tests', () => {
  ...
  it('Verify that Placeholders for all the fields exist.', () => {  
    ...
    app.addUserPage.mobileFieldElement().should('have.attr', 'placeholder',"085 012 3456");
    app.addUserPage.mobileVerifyFieldElement().should('have.attr', 'placeholder',"085 012 3456");
  });
