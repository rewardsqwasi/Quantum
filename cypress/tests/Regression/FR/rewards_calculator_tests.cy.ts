...
describe('FR Region - Rewards Calculator Tests', () => {
  ...
  it('Verify Placeholder', () => {
    app.rewardsCalculatorPage.enterProductCodeSpanElement().should('have.text', 'Entrer le code produit');
  });
  ...
  it('Verify the points are displayed against the searched product', () => {
    app.rewardsCalculatorPage.enterProductCode('GPLS FFKF06 2057');
    app.rewardsCalculatorPage.pointsFieldElement().should('have.value', '25');
  });

  it('Verify that the total points are calculated', () => {
    app.rewardsCalculatorPage.totalPointsFieldElement().should('have.value', '25');
  });
