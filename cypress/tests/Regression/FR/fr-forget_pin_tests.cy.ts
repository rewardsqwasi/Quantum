...
describe('FR Region - Forget Pin Tests', () => {
  ...
  it('Verify Forget Pin Page URL', () => {
    ...
    app.getPageTitle().should('eq','VELUX & CO - Forget your pin number');
  });
  ...
  it('Verify Click the "Send email" button without entering any details', () => {
    ...
    app.forgetPinPage.enterEmailErrorElement().should('have.text', ' Veuillez saisir une adresse e-mail valide');
  });
