...
describe('UK Region - Login Tests', () => {
  ...
  it('Verify Footer Contact Section', () => {
    ...
    app.loginPage.altaterraEmailFooterTextElement().should('be.visible');
    app.loginPage.altaterraFooterText().should('eq', 'DakeaEmail: cs@altaterra.euTel: 020 3970 5080');
  });
  ...
  it('Verify Footer Social Links Section', () => {
    ...
    app.loginPage.dakeaFacebookLinkElement().should('be.visible');
    app.loginPage.dakeaLinkedinLinkElement().should('be.visible');
    app.loginPage.dakeaYoutubeLinkElement().should('be.visible');
  });
  ...
  it('Verify Font sizes within login box', () => {
    ...
    app.loginPage.rememberMeLabelElement().should('have.css', 'font-size', '13px');
  ...
  it('Verify placeholders for email and password.', () => {
    ...
    app.loginPage.passwordFieldElement().should('have.attr', 'placeholder', 'Enter password');
  });
  ...
  it('Verify Enter invalid email, Invalid password and tick "Remember me" check box and click Login button.', () => {
    app.loginPage.login("testdummy982193@restmail.net", "test123.", true);
    app.loginPage.getToastMessagText().should('eq', 'Your login details are incorrect. Please try again or reset your password from Forgot your password? Page.');
  });

  it('Verify Enter invalid email, valid password and tick "Remember me" check box and click Login button.', () => {
    app.loginPage.login("testdummy982193@restmail.net", member.password, true);
    app.loginPage.getToastMessagText().should('eq', 'Your login details are incorrect. Please try again or reset your password from Forgot your password? Page.');
  });

  it('Verify Enter valid email, invalid password and tick "Remember me" check box and click Login button.', () => {
    app.loginPage.login(member.email, "test123.", true);
    app.loginPage.getToastMessagText().should('eq', 'Your login details are incorrect. Please try again or reset your password from Forgot your password? Page.');
  });
