...
describe('ES Region - Contact Us Tests', () => {
  ...
  it('Verify Page Title', () => {
    app.getPageTitle().should('eq','VELUX Premia - Contáctanos');
  });
  ...
  it('Verify Contact Us Section', () => {
    ...
    app.contactUsPage.headingElement().should('have.text', 'Contáctanos');
  ...
  it('Verify that the email address listed on the page is correct and functional.', () => {
    ...
    app.contactUsPage.emailElement().should('include.text', 'velux-e@velux.com');
