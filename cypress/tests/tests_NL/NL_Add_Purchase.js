...
describe('To Verify Add Purchase', () => {
  ...
  it('Should verify all header links are present and clickable', () => {
    ...
    const headerLinks = [
      ...
      'https://stage.memberportal.velux.qwasi.com/nl/add-purchase',
      'https://stage.memberportal.velux.qwasi.com/nl/claim-rewards',
      'https://stage.memberportal.velux.qwasi.com/nl/rewards-calculator',
      'https://stage.memberportal.velux.qwasi.com/nl/dashboard'
    ];
  ...
  it('Should verify the mini dashboard displays correct information', () => {
    ...
    it('Should get breadcrumb data and verify it', () => {
      ...
      cy.get('.breadcrumb-section').invoke('text').then(breadcrumbText => {
        ...
        const expectedBreadcrumbText = 'Startpagina\n\n\n\n\n\nVELUX Rewards - Factuur toevoegen';
...
it('Should verify that the "Cancel" button is clickable and redirects to the home page', () => {
    ...
    cy.url().should('eq', 'https://stage.memberportal.velux.qwasi.com/nl/home');
  });
...
//Clicking on Continue button.
  ...
  it('should Verify that the page is responsive and displays correctly on different screen sizes and resolutions.', () => {
    cy.get('.container > .menu > .relative:nth-child(2) > .flex > span').click()
