import App from '../../pageObjects/DK/AppPage';
...
describe('Sanity Test Denmark Region', () => {
  
  it('Sanity Test Denmark Region', () => {
    ...
    app.getPageTitle().should('eq','VELUX håndværkerbonus - Tjek fakturaer');
