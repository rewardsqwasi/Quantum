import App from '../../pageObjects/NO/AppPage';
...
describe('Sanity Test Norway Region', () => {
  ...
  it('Sanity Test Norway Region', () => {
    ...
    app.getPageTitle().should('eq','VELUX Bonus - Status');
    ...
    app.getPageTitle().should('eq','VELUX Bonus - Bonushistorikk');
    ...
    app.getPageTitle().should('eq','VELUX Bonus - Bonuskalkulator');
    ...
    app.getPageTitle().should('eq','VELUX Bonus - Dashboard');
