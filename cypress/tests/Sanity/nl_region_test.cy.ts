import App from '../../pageObjects/NL/AppPage';
...
describe('Sanity Test Netherland Region', () => {
  
  it('Sanity Test Netherland Region', () => {
    ...
    app.getPageTitle().should('eq','VELUX Rewards - Rewards rekenmachine');
