...
export default class BasketPage extends BasePage {
  ...
  private continue_shopping_btn = '//a[contains(text(),"Continue Shopping")]';
  private section = '//div[contains(@class,"product-details")]';
  private member_detail_heading = '//h5[contains(text(),"Member Details")]';
  private delivery_address_heading = '//h5[contains(text(),"Address")]';
  ...
  private product_points = '//span[contains(text(),"Reward Points (per unit):")]';
  private product_code = '(//div[contains(@class,"product-name")]/text())[3]';
  private quanity_input = '(//div[contains(@class,"product-name")]/text())[4]';
  private total_points = '//span[contains(text(),"Reward Points (total):")]';
  private buy_now_btn = '//input[@value="Buy Now"]';
  private remove_cart_btn = '//a[contains(@href,"cart/remove/")]';
  private basket_empty_text = '//div[contains(text(),"There are no items in your cart")]';
