...
export default class ProfilePage extends BasePage {
  ...
  howManyDakeaSelectElement(){
    return this.element(this.how_many_dakea_select);
  }
  ...
  recommendDakeaSelectElement(){
    return this.element(this.recommend_dakea_select);
  }
