...
export default class RewardsCalculatorPage extends BasePage {
  ...
  private add_your_invoice_button = '//span[contains(text(),"Add your invoice")]/parent::a';
  ...
  private enter_product_code_span = '//span[@title="Enter Product Code"]//span';
  ...
  enterProductCode(code: string){
    ...
    let product = '//li[text()="'+code+'"]/parent::ul'
    this.click2(product);
  }
  ...
  section2HeadingElement(){
    return this.element(this.section2Heading);
  }
