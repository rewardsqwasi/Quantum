...
export default class PurchaseStatusPage extends BasePage {
  ...
  private firstDataView = '(//section//table//tr[./td//i[@class="fas fa-receipt fa-lg"]])[1]/td[7]/a';
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX Rewards - Purchase Status")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
