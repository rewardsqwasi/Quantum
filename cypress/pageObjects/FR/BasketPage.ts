...
export default class BasketPage extends BasePage {
  ...
  private continue_shopping_btn = '//a[contains(text(),"Continuer mes achats")]';
  private section = '//div[contains(@class,"product-details")]';
  private member_detail_heading = '//h5[contains(text(),"Détails Du Membre")]';
  private delivery_address_heading = '//h5[contains(text(),"Adresse de livraison")]';
  ...
  private product_points = '//span[contains(text(),"Points (par article):")]';
  private product_code = '(//div[contains(@class,"product-name")]/text())[3]';
  private quanity_input = '(//div[contains(@class,"product-name")]/text())[5]';
  private total_points = '//span[contains(text(),"Points(total):")]';
  private buy_now_btn = '//input[@value="Acheter maintemant"]';
  private remove_cart_btn = '//a[contains(@href,"cart/remove/")]';
  private basket_empty_text = '//div[contains(text(),"Votre panier est vide")]';
