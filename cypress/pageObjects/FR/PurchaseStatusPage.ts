...
export default class PurchaseStatusPage extends BasePage {
  ...
  private table_header_column = '//th[contains(text(),"Aperçu")]/preceding::th[1][contains(text(),"Type")]/preceding::th[1][contains(text(),"Numéro de facture")]/preceding::th[1][contains(text(),"Statut")]/preceding::th[1][contains(text(),"Points")]/preceding::th[1][contains(text(),"Réf.")]/preceding::th[1][contains(text(),"Date")]/parent::tr';
  private table_heading = '//section//p[text()="Historique de vos points"]';
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX & CO - Statut de la facture")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
