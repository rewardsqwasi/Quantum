...
export default class HomePage extends BasePage {
  ...
  private add_purchase_btn = '//ul[@id="menu"]//a[text()="Beleg einreichen"]';
  private points_history_btn = '//ul[@id="menu"]//a[text()="Aktueller Status Ihrer Belege"]';
  private banner_section_div = '//section[@class="blue"]';
  private add_purchase_CTA = '//div[@id="member-items-up"]//a[@href="add-purchase"]';
  private purchase_status_CTA = '//div[@id="member-items-up"]//a[@href="purchase-status"]';
  private marketing_panel_div = '//div[@id="marketing-panel"]';
  private marketing_panel_img = '//div[@id="marketing-panel"]//img';
  private marketing_panel_btn = '//div[@id="marketing-panel"]//a[contains(text(),"VELUX-Newsletter abonnieren")]';
