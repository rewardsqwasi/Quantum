...
export default class AddPurchasePage extends BasePage {
  ...
  private heading = '//section//h1[contains(text(),"Beleg einreichen")]';
  private form_section = '//form[@id="formQuestionsAnswers"]';
  private cancel_btn = '//a[text()="Abbrechen"]';
  private continue_btn = '//button[text()="Fortsetzen"]';
  ...
  private add_purchase_checkbox = '#confirmationCheckbox';
  private finish_btn = '//input[@value="Beleg einreichen" and @id="finish"]';
