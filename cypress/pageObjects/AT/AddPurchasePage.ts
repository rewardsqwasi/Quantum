...
export default class AddPurchasePage extends BasePage {
  ...
  private heading = '//section//h1[contains(text(),"Rechnung einreichen - Eine Rechnung je Vorgang")]';
  private form_section = '//form[@id="formQuestionsAnswers"]';
  private cancel_btn = '//a[text()="abbestellen"]';
  private continue_btn = '//button[text()="Weitermachen"]';
  ...
  private success_purchase_toast = '//div[@class="toast-message" and text()="Ihre Rechnung wurde erfolgreich eingereicht. Die Überprüfung der Einreichung erfolgt innerhalb von 12 Wochen"]';
