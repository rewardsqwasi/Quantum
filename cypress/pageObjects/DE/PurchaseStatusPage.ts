...
export default class PurchaseStatusPage extends BasePage {
  ...
  private table_header_column = '//div[@id="tablist1-panel1"]//th[contains(text(),"Vorschau")]/preceding::th[1][contains(text(),"Art")]/preceding::th[1][contains(text(),"Eigene Notizen")]/preceding::th[1][contains(text(),"Rechnung")]/preceding::th[1][contains(text(),"Status")]/preceding::th[1][contains(text(),"Punkte/€")]/preceding::th[1][contains(text(),"Vorgang")]/preceding::th[1][contains(text(),"Datum")]/parent::tr';
