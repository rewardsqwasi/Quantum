...
export default class BasketPage extends BasePage {
  ...
  private continue_shopping_btn = '//a[contains(text(),"Continua gli acquisti")]';
  private section = '//div[contains(@class,"product-details")]';
  private member_detail_heading = '//h5[contains(text(),"I tuoi dati")]';
  private delivery_address_heading = '//h5[contains(text(),"Dati per la consegna")]';
  ...
  private product_points = '//span[contains(text(),"Punti:")]';
  private product_code = '(//div[contains(@class,"product-name")]/text())[3]';
  private quanity_input = '(//div[contains(@class,"product-name")]/text())[4]';
  private total_points = '//span[contains(text(),"Punti (totale)")]';
  private buy_now_btn = '//input[@value="Acquista"]';
  private remove_cart_btn = '//a[contains(@href,"cart/remove/")]';
  private basket_empty_text = '//div[contains(text(),"Non sono presenti articoli nel carrello")]';
