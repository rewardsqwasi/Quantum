...
export default class CreateAccountPage extends BasePage {
  ...
  private social_media_info_heading = '//h3[text()="Social media information"]';
  ...
  private create_account_login_heading = '//h3[text()="Crea account"]';
  ...
  private enter_email_error = '//span[@id="emailStatus" and text()="Inserisci un\'indirizzo e-mail valido."]';
  ...
  submitCreateAccountForm(email: string, password: string){
    ...
    this.type(this.mobile_field,'312 345 6787');
    this.type(this.verify_mobile_field,'312 345 6787');
