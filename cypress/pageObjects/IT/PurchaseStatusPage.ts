...
export default class PurchaseStatusPage extends BasePage {
  ...
  private table_header_column = '//th[contains(text(),"Vai alla richiesta")]/preceding::th[1][contains(text(),"Categoria")]/preceding::th[1][contains(text(),"N° progetto")]/preceding::th[1][contains(text(),"Stato")]/preceding::th[1][contains(text(),"Punti")]/preceding::th[1][contains(text(),"Rif")]/preceding::th[1][contains(text(),"Data")]/parent::tr';
  private table_heading = '//section//p[text()="Lo storico"]';
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX Premia - Status Richieste")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
