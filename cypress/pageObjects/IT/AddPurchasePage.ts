...
export default class AddPurchasePage extends BasePage {
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX Premia - Aggiungi certificato")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
  private heading = '//section//h4[contains(text(),"Aggiungi certificato")]';
  private headline_text = '//section//label[contains(text(),"Carica i certificati per guadagnare punti e compila il questionario")]';
  private form_heading = '//section//h1[contains(text(),"Aggiungi certificato")]';
  private form_section = '//form[@id="formQuestionsAnswers"]';
  private cancel_btn = '//span[text()="Cancella"]/parent::a';
  private continue_btn = '//span[text()="Continua"]/parent::button';
  ...
  private finish_btn = '//span[text()="Fine"]/parent::button';
