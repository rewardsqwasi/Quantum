...
export default class ClaimRewardsPage extends BasePage {
  ...
  private product_section_div = '//h1[text()="Echangez vos points dans le VELUX Club"]//ancestor::div[@id="product_list_view"]';
  private heading = '//div[@id="product_list_view"]//h1[text()="Echangez vos points dans le VELUX Club"]';
  private velux_rewards_shop_div = '//div[contains(@class,"col-span-12")]//a/b/p[contains(text(),"Dans la boutique en ligne VELUX & Me")]';
  private chasing_daylight_div = '//div[contains(@class,"col-span-12")]//a//b[contains(text(),"Chasing Daylight")]';
  private partners_div = '//div[contains(@class,"col-span-12")]//a/b/p[contains(text(),"Chez un de nos Partenaires")]';
