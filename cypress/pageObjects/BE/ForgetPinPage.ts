...
export default class ForgetPinPage extends BasePage {
  ...
  private reset_password_heading = '//h1[text()="Numéro de code oublié"]';
  ...
  private enter_email_error = '//span[@id="emailStatus" and text()="Veuillez saisir votre adresse e-mail"]';
