...
export default class ContactUsPage extends BasePage {
  ...
  private url = '/contact';
  private email = '//a[contains(@href,"mailto") and text()="professionals-be@velux.com"]';
  private section_breadcrumb = '//li[contains(text(),"VELUX Club - Contactez-nous")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
