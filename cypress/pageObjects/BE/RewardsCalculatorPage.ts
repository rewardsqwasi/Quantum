...
export default class RewardsCalculatorPage extends BasePage {
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX Club - Calcul des points")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
  private section = '//div[contains(@class,"rewardPageSection1Text")]/parent::div';
  private sectionHeading = '//h1[text()="Comment les récompenses sont-elles calculées ?"]';
  private table = '//table[@id="table-data"]';
  private add_another_product_button = '//span[contains(text(),"Ajouter un autre produit")]/parent::a';
  ...
  private enter_product_code_span = '//span[@title="Entrez le code produit"]//span';
