...
export default class RewardsHistoryPage extends BasePage {
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX Club - Historique des points")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
  ...
  private filter_button = '//button/span[text()="Filtre"]';
