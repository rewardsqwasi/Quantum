...
export default class BasketPage extends BasePage {
  ...
  private url = '/velux-shop/cart';
  private continue_shopping_btn = '//a[contains(text(),"Continuez vos achats")]';
  private section = '//div[contains(@class,"product-details")]';
  private member_detail_heading = '//h5[contains(text(),"Coordonnées du membre")]';
  private delivery_address_heading = '//h5[contains(text(),"Détails de l\'adresse")]';
  ...
  private product_points = '//span[contains(text(),"Nombre de points (par unité):")]';
  private product_code = '(//div[contains(@class,"product-name")]/text())[3]';
  private quanity_input = '(//div[contains(@class,"product-name")]/text())[4]';
  private total_points = '//span[contains(text(),"Nombre de points (total):")]';
  private buy_now_btn = '//input[@value="Acheter maintenant"]';
