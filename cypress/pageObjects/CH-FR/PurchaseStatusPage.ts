...
export default class PurchaseStatusPage extends BasePage {
  ...
  private table_header_column = '//div[@id="tablist1-panel1"]//th[contains(text(),"View")]/preceding::th[1][contains(text(),"Art")]/preceding::th[1][contains(text(),"Propres notes")]/preceding::th[1][contains(text(),"La facture")]/preceding::th[1][contains(text(),"Statut")]/preceding::th[1][contains(text(),"Points/€")]/preceding::th[1][contains(text(),"Occurrence")]/preceding::th[1][contains(text(),"Date")]/parent::tr';
  ...
  private firstDataView = '(//div[not(contains(@style,"display: none;"))]/div/table/tbody/tr[./td//i[@class="fa fa-pencil"]])[1]/td[8]/a';
