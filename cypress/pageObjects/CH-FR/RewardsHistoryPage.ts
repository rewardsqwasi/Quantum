...
export default class RewardsHistoryPage extends BasePage {
  ...
  private section_heading = '//section//p//b[text()="Retards dans la commande de bons"]';
  private my_vouchers_tab = '//li[text()="Mes bons"]';
  private all_vouchers_tab = '//li[text()="Tous les bons"]';
