...
export default class HomePage extends BasePage {
  ...
  private url = '/home';
  private edit_profile_link = '//ul[@id="top-menu"]//span[text()="Modifier le profil"]/parent::a';
  private main_btn = '//ul[@id="menu"]//a[text()="Accueil"]';
  private add_purchase_btn = '//ul[@id="menu"]//a[text()="Saisir une commande"]';
  private points_history_btn = '//ul[@id="menu"]//a[text()="Mes commandes"]';
  ...
  private marketing_panel_btn = '//div[@id="marketing-panel"]//a[contains(text(),"Télécharger maintenant le flyer")]';
  private footer_section = '//footer';
  private footer_links_section = '//footer//h6[text()="Liens"]/parent::div';
  private home_link_footer = '//footer//h6[text()="Liens"]/parent::div//span[text()="Accueil"]/parent::a';
  private terms_link_footer = '//footer//h6[text()="Liens"]/parent::div//span[text()="Conditions de participation"]/parent::a';
  private velux_privacy_link_footer = '//footer//h6[text()="Liens"]/parent::div//span[text()="Politique de confidentialité"]/parent::a';
  private contact_us_link_footer = '//footer//h6[text()="Liens"]/parent::div//span[text()="Contactez-nous"]/parent::a';
  ...
  private logout_btn = '//ul[@id="top-menu"]//span[text()="Déconnexion"]/parent::a';
  private points_panel = '//div[@id="points-panel"]';
  private current_points = '//div[@id="points-panel"]//td[text()="Total des points que j\'ai collectés"]/following-sibling::td/strong';
