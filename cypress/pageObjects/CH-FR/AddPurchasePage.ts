...
export default class AddPurchasePage extends BasePage {
  ...
  private heading = '//section//h1[contains(text(),"Soumettre la facture")]';
  private form_section = '//form[@id="formQuestionsAnswers"]';
  private cancel_btn = '//a[text()="Annuler"]';
  private continue_btn = '//button[text()="Continue"]';
  ...
  private finish_btn = '//input[@value="Soumettre la facture" and @id="finish"]';
  ...
  private dont_know_installation_checkbox = '//span[contains(text(),"Inconnu")]/preceding-sibling::input[contains(@name,"questions[3]")]';
  ...
  uploadInvoice(file: string){
    ...
    this.upload_invoice_label = '//button[text()="Ajouter une autre page"]';
