...
export default class RewardsCalculatorPage extends BasePage {
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX Rewards - Rewards rekenmachine")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
  private section = '//div[contains(@class,"rewardPageSection1Text")]/parent::div';
  private sectionHeading = '//h1/p/strong[text()="Hoe Rewards worden berekend"]';
  private table = '//table[@id="table-data"]';
  private add_another_product_button = '//span[contains(text(),"Nog een product toevoegen ")]/parent::a';
  ...
  private enter_product_code_span = '//span[@title="Voer productcode in"]//span';
