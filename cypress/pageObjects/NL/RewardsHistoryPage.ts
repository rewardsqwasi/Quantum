...
export default class RewardsHistoryPage extends BasePage {
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX Rewards - Rewards historie")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
  ...
  private filter_button = '//button/span[text()="Filteren"]';
