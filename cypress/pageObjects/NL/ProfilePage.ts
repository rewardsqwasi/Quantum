...
export default class ProfilePage extends BasePage {
  ...
  private sectionHeading = '//div[contains(@class,"sign-up-section")]//h4[text()=" Jouw profiel "]';
  ...
  private velux_reward_select = '//select[@id="q8Core"]';
  ...
  private add_user_btn = '//span[text()="Gebruiker Toevoegen"]/parent::a';
  ...
  howManyEmployeeSelectElement(){
    return this.element(this.how_many_employee_select);
  }
  ...
  veluxRewardSelectElement(){
    return this.element(this.velux_reward_select);
  }
