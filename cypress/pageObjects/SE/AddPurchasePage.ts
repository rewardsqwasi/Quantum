...
export default class AddPurchasePage extends BasePage {
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX Hantverkarbonus - Lägg till köp")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
  private heading = '//section//h4[contains(text(),"Tjäna bonuspoäng")]';
  private headline_text = '//section//label[contains(text(),"Ladda upp din faktura här för att tjäna bonuspoäng. Lägg till din information och fyll i frågeformuläret nedan.")]';
  private form_heading = '//section//h1[contains(text(),"Lägg till köp")]';
  private form_section = '//form[@id="formQuestionsAnswers"]';
  private cancel_btn = '//span[text()="Avbryt"]/parent::a';
  private continue_btn = '//span[text()="Fortsätt"]/parent::button';
  ...
  private finish_btn = '//span[text()="Lägg till köp"]/parent::button';
  private success_purchase_toast = '//div[@class="toast-message" and text()="Ditt nya köp har lagts till. Det är under behandling för närvarande men kommer vara klart inom 7 dagar."]';
  private page_heading = '//h1';
  private dont_know_installation_checkbox = '//span[text()="Vet inte"]/preceding-sibling::input[contains(@name,"questions[3]")]';
