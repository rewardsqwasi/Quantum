...
export default class RewardsCalculatorPage extends BasePage {
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX Hantverkarbonus - Poängkalkylator")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
  private section = '//div[contains(@class,"rewardPageSection1Text")]/parent::div';
  private sectionHeading = '//h1[text()="Bonuskalkylator"]';
  private table = '//table[@id="table-data"]';
  private add_another_product_button = '//span[contains(text(),"Lägg till ytterligare produkt ")]/parent::a';
  ...
  private enter_product_code_span = '//span[@title="Ange produktkod"]//span';
