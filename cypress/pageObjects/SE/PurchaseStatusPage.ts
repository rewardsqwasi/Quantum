...
export default class PurchaseStatusPage extends BasePage {
  ...
  private table_header_column = '//th[contains(text(),"")]/preceding::th[1][contains(text(),"Type")]/preceding::th[1][contains(text(),"Fakturanummer")]/preceding::th[1][contains(text(),"Status")]/preceding::th[1][contains(text(),"Bonuspoäng")]/preceding::th[1][contains(text(),"Ref")]/preceding::th[1][contains(text(),"Datum")]/parent::tr';
  private table_heading = '//section//p[text()="Din poänghistorik"]';
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX Hantverkarbonus - Inköpsstatus")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
