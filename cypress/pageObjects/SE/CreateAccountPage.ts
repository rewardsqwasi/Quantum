...
export default class CreateAccountPage extends BasePage {
  ...
  private profile_detail_heading = '//h2[text()="Skapa ett konto"]/parent::div';
  ...
  private social_media_info_heading = '//h3[text()="Info om sociala media"]';
  ...
  private create_account_login_heading = '//h3[text()="Skapa inloggning för ditt konto"]';
  ...
  submitCreateAccountForm(email: string, password: string){
    ...
    this.type(this.mobile_field,'0701234567');
    this.type(this.verify_mobile_field,'0701234567');
