...
export default class RewardsHistoryPage extends BasePage {
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX Hantverkarbonus - Bonushistorik")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
  private shop_section = '//div[contains(@class,"shop-section")]';
  private search_filter_form = '//h1[text()="Sökfilter"]/parent::div/parent::form';
