...
export default class ForgetPinPage extends BasePage {
  ...
  private reset_password_heading = '//h1[text()="Glömt PIN-kod"]';
  private email_field = '#email';
  private request_new_pass_btn = '#submit';
  private toastMessage = '.toast-message';
  private enter_email_error = '//span[@id="emailStatus" and text()="Vänligen ange e-postadress."]';
  private re_captcha_error = '//div[@id="g-recaptcha-error" and ./span[text()="reCaptcha krävs"]]';
