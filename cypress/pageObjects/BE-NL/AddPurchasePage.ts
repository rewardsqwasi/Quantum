...
export default class AddPurchasePage extends BasePage {
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX Club - Aankoop toevoegen - Eén factuur per aanvraag")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
  private heading = '//section//h4[contains(text(),"Verdien punten")]';
  private headline_text = '//section//label[contains(text(),"Upload hier uw facturen om uw beloningen te verdienen. Laat uw gegevens achter en vul onderstaande vragenlijst in.")]';
  private form_heading = '//section//h1[contains(text(),"Aankoop toevoegen - Eén factuur per aanvraag")]';
  private form_section = '//form[@id="formQuestionsAnswers"]';
  private cancel_btn = '//span[text()="Annuleren"]/parent::a';
  private continue_btn = '//span[text()="Factuur uploaden"]/parent::button';
  ...
  private finish_btn = '//span[text()="Versturen"]/parent::button';
