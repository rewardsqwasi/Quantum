...
export default class BasketPage extends BasePage {
  ...
  private continue_shopping_btn = '//a[contains(text(),"Verder winkelen")]';
  private section = '//div[contains(@class,"product-details")]';
  private member_detail_heading = '//h5[contains(text(),"Gegevens lid")]';
  private delivery_address_heading = '//h5[contains(text(),"Adresgegevens")]';
