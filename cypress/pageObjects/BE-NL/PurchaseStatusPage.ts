...
export default class PurchaseStatusPage extends BasePage {
  ...
  private table_header_column = '//th[contains(text(),"Weergeven")]/preceding::th[1][contains(text(),"Type")]/preceding::th[1][contains(text(),"Factuurnummer")]/preceding::th[1][contains(text(),"Status")]/preceding::th[1][contains(text(),"Punten")]/preceding::th[1][contains(text(),"Ref")]/preceding::th[1][contains(text(),"Datum")]/parent::tr';
  private table_heading = '//section//p[text()="Uw aankoopstatus"]';
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX Club - Aankoopstatus")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
