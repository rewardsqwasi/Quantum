...
export default class LoginPage extends BasePage {
  ...
  private velux_privacy_btn_footer = '//footer//h6[text()="Links"]/parent::div//span[contains(text(),"Privacybeleid")]/parent::a';
  private terms_btn_footer = '//footer//h6[text()="Links"]/parent::div//span[contains(text(),"Algemene Voorwaarden")]/parent::a';
  private contact_btn_header = '//ul[@id="top-menu"]//span[text()="Contact"]/parent::a';
  private contact_btn_footer = '//footer//h6[text()="Links"]/parent::div//span[text()="Contact"]/parent::a';
  private create_account_btn = '//a[text()="Een account aanmaken"]';
  private forgot_pass_btn = '//a[text()="Uw password vergeten?"]';
  private terms_btn_header = '//ul[@id="top-menu"]//span[contains(text(),"Terms") and contains(text(),"conditions")]/parent::a';
  private privacy_btn_header = '//ul[@id="top-menu"]//span[text()="Privacybeleid"]/parent::a';
  private faq_btn_header = '//ul[@id="top-menu"]//span[text()="Veelgestelde vragen"]/parent::a';
  ...
  private signIn_tab = '//legend[text()="Log in"]';
