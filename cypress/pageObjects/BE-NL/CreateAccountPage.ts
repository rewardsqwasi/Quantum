...
export default class CreateAccountPage extends BasePage {
  ...
  private profile_detail_heading = '//h2[text()="Een account aanmaken"]/parent::div';
  ...
  private create_account_login_heading = '//h3[text()="Inloggegevens aanmaken"]';
  ...
  private enter_email_error = '//span[@id="emailStatus" and text()="Gelieve een geldig e-mailadres in te geven"]';
