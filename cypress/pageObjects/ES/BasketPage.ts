...
export default class BasketPage extends BasePage {
  ...
  private continue_shopping_btn = '//a[contains(text(),"Continuar comprando")]';
  private section = '//div[contains(@class,"product-details")]';
  private member_detail_heading = '//h5[contains(text(),"Detalles del perfil")]';
  private delivery_address_heading = '//h5[contains(text(),"Dirección")]';
  ...
  private product_points = '//span[contains(text(),"Puntos:") and @data-unitprice]';
  private product_code = '(//div[contains(@class,"product-name")]/text())[3]';
  private quanity_input = '(//div[contains(@class,"product-name")]/text())[4]';
  private total_points = '//span[contains(text(),"Puntos:") and not(@data-unitprice)]';
  private buy_now_btn = '//input[@value="Comprar ahora"]';
  private remove_cart_btn = '//a[contains(@href,"cart/remove/")]';
  private basket_empty_text = '//div[contains(text(),"No hay artículos en tu carrito")]';
