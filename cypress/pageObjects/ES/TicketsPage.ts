...
export default class TicketsPage extends BasePage {
  ...
  private url = '/tickets';
  private section_breadcrumb = '//li[contains(text(),"VELUX Premia - Canjear puntos")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
  private section_div = '.shop-section';
  private future_event_heading = '//h1[contains(text(),"Próximos Eventos")]';
  private past_event_heading = '//h1[contains(text(),"Eventos pasados")]';
