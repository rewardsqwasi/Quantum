...
export default class RewardsCalculatorPage extends BasePage {
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX Premia - Calculadora de recompensas")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
  ...
  private add_another_product_button = '//span[contains(text(),"Añadir otro producto ")]/parent::a';
  ...
  private enter_product_code_span = '//span[@title="Introduce el código del producto"]//span';
