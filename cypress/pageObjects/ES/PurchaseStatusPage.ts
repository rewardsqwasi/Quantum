...
export default class PurchaseStatusPage extends BasePage {
  ...
  private table_header_column = '//th[contains(text(),"Ver")]/preceding::th[1][contains(text(),"Type")]/preceding::th[1][contains(text(),"Número de factura")]/preceding::th[1][contains(text(),"Estado")]/preceding::th[1][contains(text(),"Puntos")]/preceding::th[1][contains(text(),"Referencia")]/preceding::th[1][contains(text(),"Fecha")]/parent::tr';
  private table_heading = '//section//p[text()="Tu historial de puntos"]';
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX Premia - Estado de factura")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
