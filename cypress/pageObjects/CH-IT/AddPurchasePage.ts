...
export default class AddPurchasePage extends BasePage {
  ...
  private heading = '//section//h1[contains(text(),"Invia fattura")]';
  private form_section = '//form[@id="formQuestionsAnswers"]';
  private cancel_btn = '//a[text()="Cancella"]';
  private continue_btn = '//button[text()="Continuare"]';
  ...
  private finish_btn = '//input[@value="Invia fattura" and @id="finish"]';
  private success_purchase_toast = '//div[@class="toast-message" and text()="Nous avons reçu vos données et les traiterons dans les plus brefs délais. Vous recevrez votre crédit immédiatement après que les données auront été vérifiées et approuvées."]';
  private page_heading = '//h1';
  private dont_know_installation_checkbox = '//span[contains(text(),"Non so")]/preceding-sibling::input[contains(@name,"questions[3]")]';
  ...
  uploadInvoice(file: string){
    ...
    this.upload_invoice_label = '//button[text()="Aggiungi un\'altra pagina"]';
