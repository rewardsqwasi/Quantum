...
export default class PurchaseStatusPage extends BasePage {
  ...
  private table_header_column = '//div[@id="tablist1-panel1"]//th[contains(text(),"View")]/preceding::th[1][contains(text(),"Arte")]/preceding::th[1][contains(text(),"Proprie note")]/preceding::th[1][contains(text(),"La fattura")]/preceding::th[1][contains(text(),"Stato")]/preceding::th[1][contains(text(),"Punti/€")]/preceding::th[1][contains(text(),"Evento")]/preceding::th[1][contains(text(),"Data")]/parent::tr';
