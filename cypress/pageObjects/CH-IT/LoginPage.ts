...
export default class LoginPage extends BasePage {
  ...
  private terms_btn_header = '//ul[@id="top-menu"]//span[text()="Termini e condizioni"]/parent::a';
  private velux_privacy_btn_header = '//ul[@id="top-menu"]//span[text()="Privacy Policy"]/parent::a';
  ...
  private home_btn_footer = '//footer//h6[text()="Link"]/parent::div//span[text()="Home"]/parent::a';
  private terms_btn_footer = '//footer//h6[text()="Link"]/parent::div//span[text()="Termini e condizioni"]/parent::a';
  private velux_privacy_btn_footer = '//footer//h6[text()="Link"]/parent::div//span[text()="Privacy Policy"]/parent::a';
  private contact_btn_footer = '//footer//h6[text()="Link"]/parent::div//span[text()="Contattaci"]/parent::a';
  private create_account_btn = '//a[text()="Creare un account"]';
  private forgot_pass_btn = '//a[text()="Hai dimenticato la password?"]';
  ...
  private signIn_tab = '//legend[text()="Login"]';
