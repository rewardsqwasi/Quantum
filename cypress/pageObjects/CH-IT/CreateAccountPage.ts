...
export default class CreateAccountPage extends BasePage {
  ...
  private profile_detail_heading = '//h2[text()="Crea un account"]/parent::div';
  ...
  private social_media_info_heading = '//h3[text()="Informazioni sui social media"]';
  ...
  private create_account_login_heading = '//h3[text()="Crea il tuo nome utente"]';
  ...
  private enter_email_error = '//span[@id="emailStatus" and text()="Si prega di inserire un indirizzo email valido"]';
