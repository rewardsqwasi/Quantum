...
export default class RewardsHistoryPage extends BasePage {
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX Bonus - Bonushistorikk")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
  private shop_section = '//div[contains(@class,"shop-section")]';
  private search_filter_form = '//h1[text()="Søkefilter"]/parent::div/parent::form';
