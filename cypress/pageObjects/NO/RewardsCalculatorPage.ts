...
export default class RewardsCalculatorPage extends BasePage {
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX Bonus - Bonuskalkulator")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
  private section = '//div[contains(@class,"rewardPageSection1Text")]/parent::div';
  private sectionHeading = '//h1[text()="Bonuskalkulator"]';
  private table = '//table[@id="table-data"]';
  private add_another_product_button = '//span[contains(text(),"Legg til et annet produkt ")]/parent::a';
  private add_your_invoice_button = '//span[contains(text(),"Legg til fakturaen din")]/parent::a';
  ...
  private enter_product_code_span = '//span[@title="Skriv inn produktkode"]//span';
