...
export default class ClaimRewardsPage extends BasePage {
  ...
  private section_heading = '//section//h2[text()="VELUX & Ich"]';
  private section_heading_2 = '//section//h2[text()="Prämienpartner"]';
  private dealer_select_btn = '//a[text()="Auswählen" and contains(@href,"/dealers")]';
  private dealer_div = '//div[@class="row"]//h3/a[text()="Finden Sie Ihren Lieblings-Händler"]';
  private zalando_select_btn = '//a[text()="Auswählen" and contains(@href,"/partners/21")]';
  private zalando_div = '//div[@class="row"]//h3/a[text()="Zalando"]';
  private ticketcorner_select_btn = '//a[text()="Auswählen" and contains(@href,"/partners/22")]';
  private ticketcorner_div = '//div[@class="row"]//h3/a[text()="Ticketcorner"]';
  private media_select_btn = '//a[text()="Auswählen" and contains(@href,"/partners/23")]';
  private media_div = '//div[@class="row"]//h3/a[text()="Media Markt"]';
  private manor_select_btn = '//a[text()="Auswählen" and contains(@href,"/partners/24")]';
  private manor_div = '//div[@class="row"]//h3/a[text()="Manor"]';
  private coop_select_btn = '//a[text()="Auswählen" and contains(@href,"/partners/25")]';
  private coop_div = '//div[@class="row"]//h3/a[text()="Coop"]';
  private bonus_detail_heading = '//h1[text()="Details zu Ihrer Auswahl"]';
