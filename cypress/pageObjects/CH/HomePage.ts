...
export default class HomePage extends BasePage {
  ...
  private add_purchase_btn = '//ul[@id="menu"]//a[text()="Neue Konfiguration starten"]';
  ...
  private spend_points_btn = '//a[@href="claim-rewards"]';
  private clain_rewards_btn = '//span[contains(text(),"Claim Rewards")]/parent::a';
  private rewards_history_btn = '//a[@href="rewards-history"]';
  ...
  private dashboard_btn = '//a[@href="dashboard"]';
  ...
  clickAddPurchseBtn(){
    this.forceClick(this.add_purchase_btn);
  }
  ...
  clickDashboardBtn(){
    this.forceClick(this.dashboard_btn);
  }
