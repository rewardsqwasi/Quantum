...
export default class ShopPage extends BasePage {
  ...
  private product_section_heading = '//div[contains(@class,"products")]//h1[text()=" Produtos "]';
  ...
  private product_points = '//div[contains(@class,"product-details")]//span[contains(text(),"Pontos")]';
  private add_to_basket_btn = '//span[contains(text(),"Adicionar ao carrinho")]/parent::a';
  private success_toast = '//div[@class="toast-message" and text()="Artigo adicionado ao carrinho com sucesso"]';
  ...
  clickAddToBasket(){
    ...
    this.click(this.add_to_basket_btn);
  ...
  getProductDetail(){
    ...
    .then($el => {
      productDetails.points = $el.text().replace("Pontos de recompensa:", "").trim();
