...
export default class ProfilePage extends BasePage {
  ...
  private section_breadcrumb = '//li[contains(text(),"Recompensas VELUX - Editar perfil")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
  private section = '//div[contains(@class,"sign-up-section")]';
  private sectionHeading = '//div[contains(@class,"sign-up-section")]//h4[text()=" O seu perfil "]';
