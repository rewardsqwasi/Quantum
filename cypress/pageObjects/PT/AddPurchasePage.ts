...
export default class AddPurchasePage extends BasePage {
  ...
  private section_breadcrumb = '//li[contains(text(),"Recompensas VELUX - Submeter fatura")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
  private heading = '//section//h4[contains(text(),"Ganhar pontos")]';
  private headline_text = '//section//label[contains(text(),"Carregue aqui as suas faturas para ganhar prémios. Submeta os seus dados e preencha o questionário abaixo.")]';
  private form_heading = '//section//h1[contains(text(),"Submeter fatura")]';
  ...
  private finish_btn = '//span[text()="Adicionar fatura"]/parent::button';
  ...
  private dont_know_installation_checkbox = '//span[text()="Não sei responder"]/preceding-sibling::input[contains(@name,"questions[3]")]';
