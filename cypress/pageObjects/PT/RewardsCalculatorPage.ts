...
export default class RewardsCalculatorPage extends BasePage {
  ...
  private section_breadcrumb = '//li[contains(text(),"Recompensas VELUX - Calculadora de recompensas")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
  private section = '//div[contains(@class,"rewardPageSection1Text")]/parent::div';
  private sectionHeading = '//h1[text()="¿Cómo se calculan los premios?"]';
  private table = '//table[@id="table-data"]';
  private add_another_product_button = '//span[contains(text(),"Adicionar produtos ")]/parent::a';
  private enter_product_code_div = '//select[contains(@class,"js-product-code")]/parent::div';
  private select_product_code_btn = '//span[contains(@class,"select2-container")]/parent::div';
  private input_product_code_field = '//input[@class="select2-search__field"]'
  private enter_product_code_span = '//span[@title="Introduza o código do produto"]//span';
