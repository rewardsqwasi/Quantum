...
export default class BasketPage extends BasePage {
  ...
  private continue_shopping_btn = '//a[contains(text(),"Continuar a comprar")]';
  private section = '//div[contains(@class,"product-details")]';
  private member_detail_heading = '//h5[contains(text(),"Detalhes do perfil")]';
  private delivery_address_heading = '//h5[contains(text(),"Direção")]';
  ...
  private buy_now_btn = '//input[@value="Comprar agora"]';
  private remove_cart_btn = '//a[contains(@href,"cart/remove/")]';
  private basket_empty_text = '//div[contains(text(),"Não há artigos no seu carrinho")]';
