...
export default class PurchaseStatusPage extends BasePage {
  ...
  private table_header_column = '//th[contains(text(),"Ver")]/preceding::th[1][contains(text(),"Tipo")]/preceding::th[1][contains(text(),"Número da fatura")]/preceding::th[1][contains(text(),"Estado")]/preceding::th[1][contains(text(),"Pontos")]/preceding::th[1][contains(text(),"Referência:")]/preceding::th[1][contains(text(),"Data")]/parent::tr';
  private table_heading = '//section//p[text()="O seu histórico de pontos"]';
  ...
  private section_breadcrumb = '//li[contains(text(),"Recompensas VELUX - Estado da fatura")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
