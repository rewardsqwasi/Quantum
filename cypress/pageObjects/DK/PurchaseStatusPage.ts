...
export default class PurchaseStatusPage extends BasePage {
  ...
  private table_header_column = '//th[contains(text(),"Se/Åbn")]/preceding::th[1][contains(text(),"Type")]/preceding::th[1][contains(text(),"Faktura nummer")]/preceding::th[1][contains(text(),"Status")]/preceding::th[1][contains(text(),"Bonuskroner")]/preceding::th[1][contains(text(),"Ref")]/preceding::th[1][contains(text(),"Dato")]/parent::tr';
  private table_heading = '//section//p[text()="Tidligere optjente bonuskroner"]';
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX håndværkerbonus - Tjek fakturaer")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
