...
export default class RewardsHistoryPage extends BasePage {
  ...
  private section_breadcrumb = '//li[contains(text(),"VELUX håndværkerbonus - Historik")]/parent::ul/parent::div[contains(@class,"breadcrumb-section")]';
  ...
  private filter_button = '//button/span[text()="Filtrer"]';
