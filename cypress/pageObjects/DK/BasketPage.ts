...
export default class BasketPage extends BasePage {
  ...
  private continue_shopping_btn = '//a[contains(text(),"Fortsæt med at handle")]';
  private section = '//div[contains(@class,"product-details")]';
  private member_detail_heading = '//h5[contains(text()," Medlemsdetaljer ")]';
  private delivery_address_heading = '//h5[contains(text(),"Adresse")]';
  ...
  private product_points = '//span[contains(text(),"Bonuskroner (pr. enhed):")]';
  private product_code = '(//div[contains(@class,"product-name")]/text())[3]';
  private quanity_input = '(//div[contains(@class,"product-name")]/text())[4]';
  private total_points = '//span[contains(text(),"Bonuskroner (i alt):")]';
  private buy_now_btn = '//input[@value="Køb nu"]';
  private remove_cart_btn = '//a[contains(@href,"cart/remove/")]';
  private basket_empty_text = '//div[contains(text(),"Der er ingen varer i din indkøbskurv")]';
